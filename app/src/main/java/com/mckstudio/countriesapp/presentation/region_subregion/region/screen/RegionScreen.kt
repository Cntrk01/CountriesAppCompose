...
fun RegionScreen(
    ...
    val regionItems = listOf(
        ScreenItem(
            imageId = R.drawable.icons_antarctic,
            cardText = stringResource(R.string.antarctic),
            clickHomeItem = { clickRegionItem?.invoke(ANTARCTIC) },
            backgroundColor = MaterialTheme.colorScheme.tertiary
        ),
        ScreenItem(
            imageId = R.drawable.icons_europe,
            cardText = stringResource(R.string.europe),
            clickHomeItem = { clickRegionItem?.invoke(EUROPE) },
            backgroundColor = MaterialTheme.colorScheme.surfaceTint
        ),
        ScreenItem(
            imageId = R.drawable.icon_america,
            cardText = stringResource(R.string.americas),
            clickHomeItem = { clickRegionItem?.invoke(AMERICAS) },
            backgroundColor = MaterialTheme.colorScheme.outlineVariant
        ),
        ScreenItem(
            imageId = R.drawable.icon_africa,
            cardText = stringResource(R.string.africa),
            clickHomeItem = { clickRegionItem?.invoke(AFRICA) },
            backgroundColor = MaterialTheme.colorScheme.scrim
        ),
        ScreenItem(
            imageId = R.drawable.icon_oceania,
            cardText = stringResource(R.string.oceania),
            clickHomeItem = { clickRegionItem?.invoke(OCEANIA) },
            backgroundColor = MaterialTheme.colorScheme.onPrimaryContainer
        ),
        ScreenItem(
            imageId = R.drawable.icon_asia,
            cardText = stringResource(R.string.asia),
            clickHomeItem = { clickRegionItem?.invoke(ASIA) },
